...
3. "Finally note how areas in the Northern Territory are grey here. Note that the survey did not cover these areas, so they are predicted from the model. These estimates are very uncertainty."
:::
