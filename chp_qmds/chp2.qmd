...
<!-- ----------------------------------------------------------------- -->
## Sparsity and surveys (in Australia) {.smaller}

::: {.incremental}
- Challenge of sparsity $\to$ <span class="blR">worse</span> with survey data
  - Many areas outside the major cities are <span class="blR">excluded</span>
  - Remote areas typically have <span class="blR">poor</span> or nonexistent small area estimates
...
- For SA2 modelling $\to$ NHS is <span class="blR">highly sparse</span> survey data
- Modelling **proportions**[^3] with such sparse data gives rise to <span class="blR">unique methodological challenges</span>
:::

[^3]: We will return to proportions soon!
...
- Many Australian full BOD studies [@bodaihw; @wabod2015]
	...
	- Few have considered <span class="blR">smaller regions</span> than states
	- <span class="blR">Lack</span> of uncertainty measures
:::
