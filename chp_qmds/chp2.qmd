...
::: {.incremental}
- Interest in indices [@RN359; @RN671; @RN687; @RN360; @RN674; @RN670]
	- Instrumental in reducing the dimensionality and complexity of data
- Need to develop methods that:
	- Atlas estimates $\to$ Index
:::
